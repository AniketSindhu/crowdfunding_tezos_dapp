...
if "templates" not in __name__:
    ...
    def test():
        #c1 = Project(owner=alice.address,goalAmount=sp.tez(10),endTime=sp.timestamp_from_utc(2021, 10, 27, 4, 29, 59),name=sp.string("Example Crowdfund"), description=sp.string("Example description"))
        #scenario = sp.test_scenario()
        #scenario.h1("Project")
        #scenario += c1
        #c1.send_fund().run(sender=bob,amount=sp.tez(2))
        #c1.refund().run(sender=bob)
